...
Routing and formating

- [ ] Describe Middleware?
A function that intercepts the flow of another function, determining what happens next

- [ ] Describe a Resource?
Where information is acquired from

- [ ] What can the API return to help clients know if a request was successful?
Status codes and details

- [ ] How can we partition our application into sub-applications?
By using routes properly
